...
ui <- shinyUI(fluidPage(theme = shinytheme("cosmo"), 
                        ...
                        mainPanel(hr(),
                                  fluidRow(br(),
                                           column(6,plotOutput(outputId="forestplot_asthma",width="800px", height="650px"),align="left"),
                                           column(6,plotOutput(outputId="forestplot_GC",width="800px", height="650px"),align="left"),
