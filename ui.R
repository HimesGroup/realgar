...
ui <- shinyUI(fluidPage(theme = shinytheme("cosmo"), 
                        ...
                        mainPanel(hr(),
                                  fluidRow(br(),
                                           ...
                                           column(12,plotOutput(outputId="forestplot_GC",width="900px", height="650px"),align="left"),
                                           ...
                                           column(6, downloadButton(outputId="GC_fc_download",label="Download GC forest plot"), align="center") #,
