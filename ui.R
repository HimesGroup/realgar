                                                                ...
                                                                column(12,  
                                                                       ...
                                                                       fluidRow(div(style="margin-right: 25px", 
                                                                                    ...
                                                                                    column(3, fluidRow(checkboxGroupInput(inputId="Treatment", label="Treatment", 
                                                                                           ...
                                                                                           align="left"),
                                                                                    column(2,
                                                                                           fluidRow(checkboxGroupInput(inputId="which_SNPs", label="GWAS Results", choices=c("GABRIEL"="snp_gabriel_subs", "GRASP"="snp_subs", "EVE"="snp_eve_subs", "Ferreira"="snp_fer_subs"), selected=c("snp_subs"))),
