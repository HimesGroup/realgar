...
shinyUI(fluidPage(theme = shinytheme("cosmo"),
                  ...
                  inputPanel(column(12, offset=2, h4("Select options:",align = "left"), checkboxGroupInput(inputId="Tissue", label="Tissue", choices=c("Bronchial epithelium"="BE",
                                                                                                "Nasal epithelium"="NE","CD4"="CD4","CD8"="CD8","PBMC"="PBMC","White blood cell"="WBC", "Airway smooth muscle"="ASM",
                                                                                                "BAL"="BAL", "Whole lung"="Lung"),selected="BE" )), br(), br(),
                             column(12, checkboxGroupInput(inputId="Asthma", label="Condition", choices=c("Allergic asthma"="allergic_asthma",
                                 ...
                                 fluidRow(img(src="http://shiny.rstudio.com/tutorial/lesson2/www/bigorb.png", height=42, width=48),
                                          "Created with ",
                                          a("RStudio's shiny", href="http://www.rstudio.com/shiny"))),
                             fluidRow(p("Asthma Gene Explorer integrates publically available gene expression data from the", 
