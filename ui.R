...
ui <- shinyUI(fluidPage(theme = shinytheme("cosmo"), 
                        ...
                        wellPanel(fluidRow(align = "left",
                                           column(5,  
                                                  ...
                                                  fluidRow(column(5,checkboxGroupInput(inputId="Tissue", label="Tissue", choices=c("Bronchial epithelium"="BE","Lens epithelial cell" = "LEC",
                                                      ...
                                                      column(2,fluidRow(checkboxGroupInput(inputId="which_SNPs", label="SNPs to include", choices=c("EVE", "GABRIEL", "GRASP"), selected=c("EVE", "GABRIEL", "GRASP"))))
                                                      )))),
                                           #,
                                           # column(7,align="left",
                        ...
                        mainPanel(hr(),
                                  fluidRow(br(),
                                           column(12,plotOutput(outputId="forestplot_asthma",width="900px", height="650px"),align="left"),
                                           ...
                                           column(12,conditionalPanel(condition = "input.GC_included == 'GC'", plotOutput(outputId="forestplot_GC",width="900px", height="650px")),align="left"),
