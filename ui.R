...
ui <- shinyUI(fluidPage(theme = shinytheme("cosmo"), 
                        ...
                        mainPanel(hr(),
                                  ...
                                  fluidRow(column(12, p("Transcripts for the selected gene are displayed here. ",
                                                        "Any SNPs and/or NR3C1 binding sites that fall within the gene ",
                                                        "or within +/- 10kb of the gene are also displayed, ",
                                                        "each in a separate track. NR3C1 binding sites are colored by the ",
                                                        ...
                                                        "SNP p-values come from the study in which they were found, ",
                                                        "and only those SNPs with p-value <= 0.05 are displayed.")),
