...
ui <- shinyUI(fluidPage(theme = shinytheme("lumen"), 
                            ...
                            wellPanel(fluidRow(align = "left",
                                           column(12,  
                                                  ...
                                                  column(3, fluidRow(checkboxGroupInput(inputId="Treatment", label="Treatment", 
                                                                                   choice = c("Beta-agonist treatment"="BA", "Glucocorticoid treatment" = "GC", "Smoking"="smoking", "Vitamin D treatment"="vitD"), selected="")),
                        ...
                        mainPanel(hr(),
                                  ...
                                  fluidRow(column(12, p("Transcripts for the selected gene are displayed here. ",
                                           ...
                                           column(12, HTML("<div style='height: 65px;'>"), imageOutput("color_scale3"), align="center", HTML("</div>")),
