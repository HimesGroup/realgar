...
ui <- shinyUI(fluidPage(theme = shinytheme("lumen"), 
                                           ...
                                           column(12,  
                                                  ...
                                                  fluidRow(div(style="margin-right: 25px", 
                                                               column(5, fluidRow(checkboxGroupInput(inputId="Tissue", label="Tissue", choices=c("Airway smooth muscle"="ASM", "Bronchial epithelium"="BE", 
                                                                      ...
                                                                      fluidRow(actionButton("selectall_tissue","Select/unselect all"))),
                                                                      column(2, fluidRow(checkboxGroupInput(inputId="Asthma", label="Asthma Type", choices=c("Allergic asthma"="allergic_asthma", "Asthma"="asthma", "Asthma and rhinitis"="asthma_and_rhinitis",
                                                                                                                                                 ...
                                                                                                                                                 "Non-asthma smoker"="non_asthma_smoker","Severe asthma"="severe_asthma"), selected="asthma"), inline = TRUE),
                                                                 fluidRow(actionButton("selectall_asthma","Select/unselect all")), align="left"),
                                                  column(3, fluidRow(checkboxGroupInput(inputId="Treatment", label="Treatment", 
                                                                     ...
                                                                     fluidRow(actionButton("selectall_treatment","Select/unselect all")),
                        ...
                        mainPanel(hr(),
                                  fluidRow(br(),
                                           ...
                                           column(10, conditionalPanel(condition = "input.Treatment != ''", br(), br(), plotOutput(outputId="forestplot_GC",width="970px", height="650px")),align="left"),
