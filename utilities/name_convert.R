...
tissue_short_name <- c("ASM", "BE", "BAL", "CD4", "CD8", "LEC", "chALL", "LCL", "MACRO", "MCF10A-Myc", "NE", "U2OS", "PBMC", "SAE", "myotubes","WBC", "Lung")
tissue_full_name <- c("Airway smooth muscle", "Bronchial epithelium", "Bronchoalveolar lavage", "CD4", "CD8", "Lens epithelium", "Lymphoblastic leukemia cell", "Lymphoblastoid cell", "Macrophage", "MCF10A-Myc", "Nasal epithelium", "Osteosarcoma U2OS cell", "Peripheral blood mononuclear cell","Small airway epithelium", "Skeletal muscle myotubes",
                      "White blood cell","Whole lung")
